            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        ...
                        <a href="https://platform.myceliot.com/" target="_blank" rel="noopener noreferrer" className="px-6 py-2 rounded-sm border border-primary text-primary hover:bg-primary/10 transition-colors font-medium text-sm tracking-wide">
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-surface border-b border-white/5">
                    <div className="px-4 pt-2 pb-6 space-y-4">
                        ...
                        <a href="https://platform.myceliot.com/" target="_blank" rel="noopener noreferrer" className="block text-center w-full mt-4 px-6 py-3 rounded-sm border border-primary text-primary hover:bg-primary/10 transition-colors font-medium text-sm">
                            {t('header.platformAccess')}
                        </a>
                    </div>
                </div>
